...
delayType.1 = Submitting a report of receipt
delayType.2 = Providing a consignee or change of destination for the movement
delayType.checkYourAnswersLabel = What’s been delayed
delayType.error.required = Select what’s been delayed
delayType.change.hidden = what’s been delayed

delayReason.title = Why has {0} been delayed?
delayReason.heading = Why has {0} been delayed?
delayReason.heading.1 = submitting a report of receipt
delayReason.heading.2 = providing a consignee or change of destination for the movement
delayReason.0 = Other
delayReason.1 = The commercial transaction has been cancelled
delayReason.2 = The commercial transaction is pending
delayReason.3 = Ongoing investigation by officials
delayReason.4 = Bad weather conditions
delayReason.5 = Strike action
delayReason.6 = An accident in transit
delayReason.checkYourAnswersLabel = Reason for delay
...
delayDetails.checkYourAnswersLabel = More information about the delay
delayDetails.checkYourAnswers.noDelayInformationValue = Give more information about the delay
...
journeyRecovery.p2 = To submit an explanation of delay you must:
...
journeyRecovery.numbered3 = Select to ‘Submit explanation for delay’
...
confirmation.whatNext.p1 = The movement will be updated to show you have successfully submitted an explanation for delay. This may not happen straight away.
confirmation.mayNeedToDo.h2 = What you may need to do
confirmation.mayNeedToDo.p1 = This explanation for delay has been submitted to HMRC only. You may also need to notify the consignor or consignee that you have done this.
confirmation.mayNeedToDo.p2 = If you are the consignee you will still need to submit a report of receipt for this movement.
