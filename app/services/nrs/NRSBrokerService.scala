...
import models.nrs.{ExplainDelayNRSSubmission, IdentityData, NRSPayload}
...
class NRSBrokerService @Inject()(brokerConnector: NRSBrokerConnector,
  ...
  def submitPayload(submission: SubmitExplainDelayModel, ern: String)
    ...
    val submissionAsString = Json.stringify(Json.toJson(ExplainDelayNRSSubmission(ern, submission)))
