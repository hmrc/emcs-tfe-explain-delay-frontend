...
class UserAnswersConnector @Inject()(val http: HttpClientV2,
  ...
  def get(ern: String, arc: String)
    ...
    http
      .get(url"$baseUrl/user-answers/explain-delay/$ern/$arc")
  ...
  def put(userAnswers: UserAnswers)
    ...
    http
      .put(url"$baseUrl/user-answers/explain-delay/${userAnswers.ern}/${userAnswers.arc}")
    ...
    def delete(ern: String, arc: String)
      ...
      http
        .delete(url"$baseUrl/user-answers/explain-delay/$ern/$arc")
