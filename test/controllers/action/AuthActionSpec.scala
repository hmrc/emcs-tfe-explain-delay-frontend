    ...
    "calling .apply(ern)" - {
      ...
      "User is not logged in" - {
        ...
        "redirect to the sign-in URL with the ContinueURL set" in new Harness {
          ...
          redirectLocation(result) mustBe Some("http://localhost:9949/auth-login-stub/gg-sign-in?continue=http%3A%2F%2Flocalhost%3A8316%2Femcs%2Fexplain-delay%2Fern%2Farc")
        }
      }
